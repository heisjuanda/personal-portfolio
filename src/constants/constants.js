...
export { DIRECTION, FACING, CHARACTER_IMAGES, PX_PER_HOP, SIDE, DOOR_MARGIN, SCROLL_TIP_THRESHOLD, SCROLL_TIP_DELAY, SOUND_HINT_DELAY, SOUND_HINT_DURATION, CONSENT_NOTICE_DELAY, CONSENT_NOTICE_EXIT, PLANE };