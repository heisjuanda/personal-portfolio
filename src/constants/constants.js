...
const PX_PER_HOP = 20;
const CHARACTER_IDLE_DELAY = 500;
const SCROLL_TIP_THRESHOLD = 100;
const DOOR_MARGIN = 10;

const SCROLL_TIP_DELAY = 1500;
...
// Constant for the year of career start
...
export { DIRECTION, FACING, CHARACTER_IMAGES, PX_PER_HOP, CHARACTER_IDLE_DELAY, SIDE, DOOR_MARGIN, SCROLL_TIP_THRESHOLD, SCROLL_TIP_DELAY, SOUND_HINT_DELAY, SOUND_HINT_DURATION, CONSENT_NOTICE_DELAY, CONSENT_NOTICE_EXIT, NAV_PEEK_DELAY, NAV_PEEK_DURATION, PLANE, CAREER_START_YEAR };